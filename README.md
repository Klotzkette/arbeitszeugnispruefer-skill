...
Konsolidierter Skill (Version 2.2.6) für die Prüfung deutscher Arbeitszeugnisse nach dem Ampelsystem — Befunde werden als farbige Ampelsymbole 🔴/🟠/🟢 ausgegeben, nicht als Farbwörter. Der Skill bündelt eine ursprünglich 50-teilige Plugin-Sammlung in eine einzige `SKILL.md` und deckt den vollständigen Bogen ab — vom Mandanten-Intake über die satzweise Notenmatrix bis zur Klagestrategie auf Zeugnisberichtigung. Version 2.2.6 enthält die Mini-Fassung, die HR-/Arbeitgeber-Rollenlogik, eine präzisere Vollstreckungswarnung zu BAG 8 AZB 25/25, klarere Download-Hinweise, eine genauere Fristenprüfung, bereinigte Kosten-/Abschlusshinweise zu § 12a ArbGG und eine klarere Beweislastformel.
