...
Konsolidierter Skill (Version 2.2.17) für die Prüfung deutscher Arbeitszeugnisse nach dem Ampelsystem — Befunde werden als farbige Ampelsymbole 🔴/🟠/🟢 ausgegeben, nicht als Farbwörter. Der Skill bündelt eine ursprünglich 50-teilige Plugin-Sammlung in eine einzige `SKILL.md` und deckt den vollständigen Bogen ab — vom Mandanten-Intake über die satzweise Notenmatrix bis zur Klagestrategie auf Zeugnisberichtigung. Version 2.2.17 ergänzt die aktuelle BAG-Linie zum unwirksamen Zukunftsverzicht auf ein qualifiziertes Zeugnis vor Beendigung des Arbeitsverhältnisses.
